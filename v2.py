...
#-------------[ PENGATURAN-IDZ ]---------------#
def setting():
	print('[bold cyan]MAU CARI AKUN YANG MANA ? [bold cyan]') 
	print('') 
    cetak(nel('[bold purple]1. Akun Old\n 2. Akun New [bold purple]')) 
	print('')
	hu = input('----> Pilih : ')
	if hu in ['1','01']:
...
#			id2.insert(xx,bacot)
		...
		exit()
		print('[bold cyan]SILAKAN PILIH METODE LOGIN YG KAU SUKA[bold cyan]')
		print('') 
